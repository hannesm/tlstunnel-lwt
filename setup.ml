...
(* OASIS_START *)
(* DO NOT EDIT (digest: cd1aac79c399217662df66bdbe4d6354) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/hannesm/tlstunnel";
          synopsis = "TLS tunnel";
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some
                        (("./_build/src/tlstunnel.native",
                           ["--help"; ">"; "./_build/src/tlstunnel.1"])))
                 ]
            };
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = [];
                      bs_data_files =
                        [("../_build/src/tlstunnel.1", Some "$mandir")];
                   ...
                   {exec_custom = false; exec_main_is = "tlstunnel.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/hannesm/tlstunnel.git";
                      src_repo_browser =
                        Some "https://github.com/hannesm/tlstunnel";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\192\130\021\134\206 `\170\164kY\239\031\028v\191";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
