...
(* OASIS_START *)
(* DO NOT EDIT (digest: 87b7a2df037bcb677d02c094262b7040) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/hannesm/secshaft";
          synopsis = "Secure tunnel";
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "secshaft.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\233\234\017\006g7\b\025\021\246ud\246u\158\233";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
